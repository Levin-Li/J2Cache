...
import net.oschina.j2cache.hibernate.domain.Event;
import net.oschina.j2cache.hibernate.domain.EventManager;
import net.oschina.j2cache.hibernate.domain.Item;
import net.oschina.j2cache.hibernate.domain.Person;
import net.oschina.j2cache.hibernate.domain.PhoneNumber;
import net.oschina.j2cache.hibernate.domain.VersionedItem;
...
/**
 */
public class J2CacheRegionFactoryTest extends BaseCoreFunctionalTestCase {
    ...
    public void testEmptySecondLevelCacheEntry() throws Exception {
        ...
        stats.clear();
        SecondLevelCacheStatistics statistics = stats.getSecondLevelCacheStatistics(REGION_PREFIX
                                                                                    + Item.class.getName());
